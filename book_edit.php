...
if (isset($_GET['search'])) {
    ...
    $searchQuery = "SELECT ID, NAME, `DESC`, WRITER , STATUS, IMAGE FROM $tableName 
                WHERE NAME LIKE '%$searchTerm%' OR `DESC` LIKE '%$searchTerm%' OR WRITER LIKE '%$searchTerm%'";
...
<div class="content-wrapper transition-all duration-150 ltr:ml-[248px] rtl:mr-[248px]" id="content_wrapper">
    ...
    <ul class="m-0 p-0 list-none">
        <li>
            <input name="data_enter" class="search_pat" type="text" placeholder="Enter Data To Search" value="<?php echo isset($_GET['data_enter']) ? $_GET['data_enter'] : ''; ?>">
                                                    ...
                                                    <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                        <?php while ($book = mysqli_fetch_array($result)) { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="table-td">
                                                                            <?php 
                                                                            $imageUrl = "images/" . $book['IMAGE'];
                                                                            echo '<img style="width: 100px; height:100px" src="' . $imageUrl . '" alt="" class="block w-full h-full object-cover rounded-md">';
                                                                            ?>
                                                                        </td>
                                                                        <td class="table-td"><?php echo $book['NAME']; ?></td>
                                                                        <td class="table-td"><?php echo $book['WRITER']; ?></td>
                                                                        <td class="table-td"><?php echo $book['DESC']; ?></td>
