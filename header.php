...
if (array_key_exists('user_type', $_SESSION) && ($_SESSION['user_type'] == 'user' || $_SESSION['user_type'] == 'librarian')) {
    ...
    $db = new Database();
    $searchQuery = $db->select($tableName, "status", "id = $userId");
    $row = $searchQuery->fetch_assoc();
    if(array_key_exists('status', $row) && $row['status'] == 0) {
        echo"<script>alert('you are deactivated')</script>";
        session_destroy();
...
<body class=" font-inter dashcode-app" id="body_class">
        ...
        <div class="sidebar-wrapper group">
            ...
            <div class="logo-segment">
                <a class="flex items-center" href="index.php  ">
                    <span class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white">Book Store</span>
                </a>
                <!-- Sidebar Type Button -->
            ...
            <?php
                ...
                if ($user_type == 'admin') { ?>
                            <li class="sidebar-menu-title">ADMIN MENU</li>
                                <li class="">
                                    <a href="javascript:void(0)" class="navItem">
                                        <span class="flex items-center">
                                            ...
                                            <span>Books Sign Up Detail</span>
                                        </span>
                                        <iconify-icon class="icon-arrow" icon="heroicons-outline:chevron-right"></iconify-icon>
                                    </a>
                                    <ul class="sidebar-submenu">
                                            <li>
                                                <a href="user-detail.php">User Detail</a>
                                            </li>
                                            <li>
                                                <a href="libradian-detail.php">Libradian Detail</a>
                                            </li>
                                            <!-- <li>
                                                <a href="show-user.php">Show Admin</a>
                                            </li>
                                            <li>
                                ...
                                <li class="sidebar-menu-title">BOOKS</li>
    ...
    overflow-hidden">
                                    ...
                                    <div>
                                        <button id="grayScale" class="lg:h-[32px] lg:w-[32px] lg:bg-slate-100 lg:dark:bg-slate-900 dark:text-white text-slate-900 cursor-pointerrounded-full text-[20px] flex flex-col items-center justify-center">
    ...
    before:top-0 before:left-0">
        ...
        inline-flex items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            ...
                                            <span class="flex-none text-slate-600 dark:text-white text-sm font-normal items-center lg:flex hidden overflow-hidden text-ellipsis whitespace-nowrap">Book Store</span>
