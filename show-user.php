...
$tableName = "admin";
$columnsToSelect = "ID, NAME, EMAIL,STATUS";
...
if (isset($_GET['search'])) {
    ...
    $searchQuery = "SELECT ID, NAME, EMAIL,STATUS FROM $tableName 
