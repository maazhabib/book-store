...
$pat = "SELECT * FROM `hospital_signup` LIMIT $start,$perpage";


if (isset($_POST['search'])) {

    $hosName = $_POST['data_enter'];

    $hosReg = "/^[A-Za-z]{1,30}/";


    if (preg_match($hosReg, $hosName)) {
        $pat = "SELECT * FROM `hospital_signup` where name = '{$hosName}' ";
    } else {
        $error = "No Data Here";
    }
}
                        ...
                        <div class="mb-5">
                            <form method="post">
                                <ul class="m-0 p-0 list-none">
                                    ...
                                    <li>
                                        <input name="data_enter" class="search_pat" type="text" placeholder="Enter Hospital name " required>
                                ...
                                <div class="card-body px-6 rounded overflow-hidden">
                                    ...
                                    <div class="space-x-2 py-4">
                                            ...
                                            <div class="card-text h-full space-y-10">
                                                <ul class="list-none">
                                                    <li class="inline-block">
                                                        <a href="hospital_signup.php?page=<?php echo ($page - 1) ?>" class="flex items-center justify-center w-6 h-6 bg-slate-100 dark:bg-slate-700 dark:hover:bg-black-500 text-slate-800
                                      ...
                                      duration-300 relative top-[2px] pl-2">
                                            ...
                                            $fetch = "SELECT * FROM `hospital_signup`";
                                            ...
                                            for ($i = 1; $i <= $total_pages; $i++) {
                                                ...
                                                ?>
                                                    ...
                                                    <li class="inline-block">
                                                        <a href="hospital_signup.php" class="flex items-center justify-center w-6 h-6 bg-slate-100 dark:bg-slate-700 dark:hover:bg-black-500 text-slate-800
                                      dark:text-white rounded mx-1 hover:bg-black-500 hover:text-white text-sm font-Inter font-medium transition-all
